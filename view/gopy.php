  ...
  <div class="content">
    <div class="detail">
      <div class="detail__box">
        <div class="detail__name">Gửi phản hồi</div>
        <div class="cart">
          <form action="submit_feedback.php" method="POST">
            <p class="acc__title">Tên</p>
            <div class="input-container">
              <input autofocus placeholder="Nhập tên" class="input-field" type="text" id="name" name="name" required>
            ...
            <p style="margin-bottom: 10px;" class="acc__title">Phản hồi</p>
